...
public class SelectorTest extends TestCase {
    ...
    public void disabledTestXPathSelectors() throws Exception {
        HedwigJMSTextMessage message = new HedwigJMSTextMessage(new MockHedwigSession());
    ...
    protected void assertSelector(Message message, String text, boolean expected) throws JMSException {
        ...
        context.setMessage((HedwigJMSMessage) message);
