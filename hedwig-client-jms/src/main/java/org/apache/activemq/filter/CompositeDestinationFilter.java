...
public class CompositeDestinationFilter extends DestinationFilter {
    ...
    public CompositeDestinationFilter(HedwigDestination destination) {
        HedwigDestination[] destinations = destination.getCompositeDestinations();
    ...
    public boolean matches(HedwigDestination destination) {
