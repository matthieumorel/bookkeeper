...
public final class DestinationPath {
    ...
    public static String[] getDestinationPaths(HedwigJMSMessage message) throws JMSException {
        throw new RuntimeException("not implemented");
        // return getDestinationPaths(message.getJMSDestination());
    }

    public static String[] getDestinationPaths(HedwigDestination destination) {
        throw new RuntimeException("not implemented");
